...
export class GatewayService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createGateway(body: GatewayCreateDTO, observe?: 'body', reportProgress?: boolean): Observable<GatewayDTO>;
    public createGateway(body: GatewayCreateDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GatewayDTO>>;
    public createGateway(body: GatewayCreateDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GatewayDTO>>;
    public createGateway(body: GatewayCreateDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public queryGateways(body: GatewayQueryDTO, observe?: 'body', reportProgress?: boolean): Observable<GatewayDTO>;
    public queryGateways(body: GatewayQueryDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GatewayDTO>>;
    public queryGateways(body: GatewayQueryDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GatewayDTO>>;
    public queryGateways(body: GatewayQueryDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
