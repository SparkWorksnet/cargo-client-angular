...
export class ResourceService {
     ...
     * @param resourceCreateDTO Resource Creation API Model
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public createResource(resourceCreateDTO: ResourceCreateDTO, observe?: 'body', reportProgress?: boolean): Observable<ResourceDTO>;
    public createResource(resourceCreateDTO: ResourceCreateDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResourceDTO>>;
    public createResource(resourceCreateDTO: ResourceCreateDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResourceDTO>>;
    public createResource(resourceCreateDTO: ResourceCreateDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (resourceCreateDTO === null || resourceCreateDTO === undefined) {
            throw new Error('Required parameter resourceCreateDTO was null or undefined when calling createResource.');
        }
     ...
     * @param resourceQueryDTO The Resource Query
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public queryResources(resourceQueryDTO: ResourceQueryDTO, observe?: 'body', reportProgress?: boolean): Observable<ResourceDTO>;
    public queryResources(resourceQueryDTO: ResourceQueryDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResourceDTO>>;
    public queryResources(resourceQueryDTO: ResourceQueryDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResourceDTO>>;
    public queryResources(resourceQueryDTO: ResourceQueryDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (resourceQueryDTO === null || resourceQueryDTO === undefined) {
            throw new Error('Required parameter resourceQueryDTO was null or undefined when calling queryResources.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateResource(uuid: string, resourceUpdateDTO: ResourceUpdateDTO, observe?: 'body', reportProgress?: boolean): Observable<ResourceDTO>;
    public updateResource(uuid: string, resourceUpdateDTO: ResourceUpdateDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResourceDTO>>;
    public updateResource(uuid: string, resourceUpdateDTO: ResourceUpdateDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResourceDTO>>;
    public updateResource(uuid: string, resourceUpdateDTO: ResourceUpdateDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (uuid === null || uuid === undefined) {
            throw new Error('Required parameter uuid was null or undefined when calling updateResource.');
        }

        if (resourceUpdateDTO === null || resourceUpdateDTO === undefined) {
