...
var CommandService = /** @class */ (function () {
    ...
    CommandService.prototype.sendCommand = function (uuid, commandDto, observe, reportProgress) {
        ...
        return this.httpClient.post(this.basePath + "/v2/command/" + encodeURIComponent(String(uuid)), commandDto, {
