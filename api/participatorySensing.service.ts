...
export class ParticipatorySensingService {
     ...
     */
    public createPsResource(body: AParticipatorySensingResourceRequestAPIModel, observe?: 'body', reportProgress?: boolean): Observable<ResourceDTO>;
    public createPsResource(body: AParticipatorySensingResourceRequestAPIModel, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResourceDTO>>;
    public createPsResource(body: AParticipatorySensingResourceRequestAPIModel, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResourceDTO>>;
    public createPsResource(body: AParticipatorySensingResourceRequestAPIModel, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling createPsResource.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public publishPsData(body: PublishDataListDTOAPIModel, observe?: 'body', reportProgress?: boolean): Observable<PublishDataListDTOAPIModel>;
    public publishPsData(body: PublishDataListDTOAPIModel, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PublishDataListDTOAPIModel>>;
    public publishPsData(body: PublishDataListDTOAPIModel, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PublishDataListDTOAPIModel>>;
    public publishPsData(body: PublishDataListDTOAPIModel, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling publishPsData.');
        }
